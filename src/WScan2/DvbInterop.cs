...
{
    // ioctl request codes (computed with _IOC macros on x86_64)
...
public enum DeliverySystem : uint
{
    Undefined = 0,
    DVBC_AnnexA = 1,
    DVBC_AnnexB = 2,
...
{
    public uint Num;
    public IntPtr Props; // pointer to DtvProperty array
}
